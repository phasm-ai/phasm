...
BOT_CACHE_PATH = './bots/hit-looper/.phasm/project.cache.json'
...
local_resource(
  ...
  cmd="pnpm turbo -F @phasmhub/hitl-plugin build && pnpm -F @bp-bots/hit-looper exec bp add -y --use-dev",
