...
Official phasm HTTP client for TypeScript. Queries the [phasm API](https://phasm.com/docs/api/).

## Installation

```bash
npm install --save @phasm/client # for npm
yarn add @phasm/client # for yarn
pnpm add @phasm/client # for pnpm
```
